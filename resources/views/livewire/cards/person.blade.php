<div class="w-full lg:w-1/2 px-4 mb-8 flex" wire:poll.{{$this->poll}}>
    ...
    <div class="w-full1 lg:w-1/3 pl-0 px-4 mb-8">
        <div class="max-w-sm rounded overflow-hidden shadow-lg">
            <img class="w-full" src="https://picsum.photos/200?random={{random_int(1, 1000)}}" alt="Sunset in the mountains">
            <div class="px-6 py-4">
    ...
    <div class="w-full lg:w-1/3 px-4 pr-0 mb-8">
        <div class="max-w-sm rounded overflow-hidden shadow-lg">
            <img class="w-full" src="https://picsum.photos/200?random={{random_int(1, 1000)}}" alt="Sunset in the mountains">
            <div class="px-6 py-4">
